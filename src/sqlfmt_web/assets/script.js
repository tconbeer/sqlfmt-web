...
// change favicon
$('#favicon32,#favicon16').remove(); $('head').append('<link rel="icon" type="image/x-icon" href="https://d3cu51zofuxukg.cloudfront.net/favicon.ico">')
// refresh page if connection to server is lost
WebIO._state.CurrentSession.on_session_close(()=>{setTimeout(()=>location.reload(), 4000)});
// define functions for managing light/dark modes
